...
//
//**********************************************************************************************
void CVersionInfo::GetVersionInfo (const LPTSTR szFilename, LPCTSTR strLangID/*=NULL*/, LPCTSTR strInfoType/*=NULL*/)
{
	DWORD dwVerInfoSize;
	DWORD dwHnd;
	void* pBuffer; 
	...
	{ 
		  ...
		  m_strFixedFileVersion.Format ( _T("%u,%u,%u,%u") ,HIWORD (pFixedInfo->dwFileVersionMS),
